<template>
  <div
    class="code_editor hljs github_dark"
    :class="{
  ...
  >
    ...
    >
      <textarea
        v-if="
          read_only === true ? false : value === undefined ? true : false
        "
        :autofocus="autofocus"
      ...
      <textarea
        v-if="
          read_only === true ? false : value === undefined ? false : true
        "
        :autofocus="autofocus"
        @keydown.tab.prevent="tab"
        v-on:scroll="scroll"
      ...
      <pre>
        <code
            ...
            v-html="read_only === true ? value : value === undefined ? staticValue + '\n' : value + '\n'"
        ></code>
      </pre>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      content:
        this.value === undefined ? this.staticValue : this.value,
    };
  },
  computed: {
    canScroll() {
  ...
  watch: {
    value(val) {
      ...
      hljs.highlightAll();
      this.content =
        val === undefined ? this.staticValue : val;
    }
  },
  methods: {
    calcContainerWidth(event) {
